    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg lg:p-8 p-6">
                <h1 class="text-2xl font-bold text-gray-950">Create New Post</h1>
                <form action="{{ route('post.store') }}" enctype="multipart/form-data" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        {{-- <x-editor></x-editor> --}}
                        <x-input-textarea id="content" name="content" class="mt-1 w-full" type="text"
